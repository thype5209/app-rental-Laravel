...
<template>
    <div class="carousel w-full h-max relative box-border py-3 md:py-10">
        <carousel :items-to-show="2" :items-to-scroll="1" class="w-full" :autoplay="2000" :wrapAround="true">
            <slide v-for="slide in 4" :key="slide" class="w-full">
                <div
                    ...
                    <div class="space-y-6">
                        <h6 class="text-xs md:text-xl font-medium text-gray-900 ">Nama Mobil/Spesifikasi</h6>

                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        <tr v-for="(mobil, index) in status.sewa.data" :key="mobil" :index="index"
                            ...
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">{{ index + 1 }}</td>
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">{{ mobil.kode }}</td>
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">{{ mobil.nik }}</td>
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">{{ mobil.pengguna.nama }}</td>
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">{{ mobil.nopol }}</td>
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">{{ mobil.waktusewa.tgl_sewa }}</td>
                            <td class="md:px-4 md:py-3 px-2 py-2 text-sm">
                                {{ mobil.waktusewa.tgl_kembali }}
                                <br />
                                <span class="text-xs text-red-500">{{ diffDate(mobil.waktusewa.tgl_kembali) }} Hari lagi</span>
                            </td>

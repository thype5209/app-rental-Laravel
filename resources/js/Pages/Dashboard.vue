        ...
        <div class="mt-8 mx-4">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <form class="p-6 flex flex-col justify-center">
                    ...
                    <button type="submit"
                        class="md:w-32 bg-blue-600 dark:bg-gray-100 text-white dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-default-dark dark:hover:bg-gray-200 transition ease-in-out duration-300">Submit</button>
                </form>
            </div>
        </div>
        <!-- ./Contact Form -->
